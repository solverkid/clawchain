...
const translations = {
  en: {
    ...
    step2Desc: 'Query challenges → LLM solves → Submit answers',
    step3Title: 'Earn $CLAW',
    step3Desc: 'Rewards sent to your wallet. Early miners get 3x multiplier',
  ...
  zh: {
    ...
    step2Desc: '查询挑战 → LLM解题 → 提交答案',
    step3Title: '赚 $CLAW',
    step3Desc: '奖励打到钱包，早期矿工享 3x 倍率',
    mechTitle: '挖矿机制',
    earlyTitle: '🏆 早鸟奖励',
    early1: '前 1,000 矿工:',
    early1x: '3x',
