...
const translations = {
  en: {
    ...
    trust3Desc: 'Each epoch settlement is anchored with a SHA256 root for auditability. Alpha uses local file-based anchoring with chain liveness verification. On-chain tx-level anchoring in Beta; full consensus-level settlement in Mainnet.',
  ...
  zh: {
    ...
    trust3Desc: '每个 epoch 结算以 SHA256 root 锚定，提升可审计性。Alpha 使用本地文件锚定 + 链存活验证。Beta 实现链交易级锚定；Mainnet 实现共识级多验证者结算。',
