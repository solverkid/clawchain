...
const translations = {
  en: {
    ...
    sec3Desc: '10% of challenges use known answers — wrong answer docks reputation',
    ...
    trust1Desc: 'Math, logic, hash challenges use commitment verification — trust-minimized, fully verifiable.',
    trust2Title: '🔄 Non-Deterministic Tasks',
    trust2Desc: 'Sentiment, translation challenges currently rely on mining service judgment. Future upgrade: multi-validator voting.',
    trust3Title: '📊 Reward Settlement',
    trust3Desc: 'Currently computed server-side. Auditable via the stats API. On-chain settlement planned for mainnet.',
