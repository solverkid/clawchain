...
const translations = {
  en: {
    ...
    trust3Desc: 'Each epoch settlement is anchored with a SHA256 root for auditability. Alpha uses local anchoring with chain liveness verification; true on-chain consensus anchoring planned for Beta.',
  ...
  zh: {
    ...
    trust3Desc: '每个 epoch 结算以 SHA256 root 锚定，提升可审计性。Alpha 使用本地锚定 + 链存活验证；链上共识锚定计划在 Beta 实现。',
