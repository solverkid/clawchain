...
forecast_submissions = Table(
    ...
    Column("fast_direct_score", Integer, nullable=False, default=0),
    Column("model_reliability_component", Float, nullable=False, default=1.0),
    Column("ops_reliability_component", Float, nullable=False, default=1.0),
    Column("arena_multiplier_component", Float, nullable=False, default=1.0),
    Column("anti_abuse_discount", Float, nullable=False, default=1.0),
    Column("quality_envelope", Float, nullable=False, default=1.0),
    Column("reward_amount", Integer, nullable=False, default=0),
    Column("released_reward_amount", Integer, nullable=False, default=0),
    Column("held_reward_amount", Integer, nullable=False, default=0),
    Column("reward_window_id", String, nullable=True),
...
poker_mtt_final_rankings = Table(
    ...
    Column("display_rank", Integer, nullable=True),
    Column("rank_state", String, nullable=False),
    Column("rank_basis", String, nullable=True),
    Column("rank_tiebreaker", String, nullable=True),
